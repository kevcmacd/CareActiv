...
Care Activity App
1) Start by installing WampServer from http://www.wampserver.com/en/

2) Once it is installed make sure the icon on your system tray is green. If it is not left click on it and click start all services. If it still isnt green you may need to do some troubleshooting. 
